...
<code>{% raw %}
  {% include collection_gallery.html collection='hdadr'
...
<code>{% raw %}{% include collection_gallery.html collection='hdadr' facet_by='object_type' only='portrait' num_column=4 %}{% endraw %}</code>
