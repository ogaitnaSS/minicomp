...
`{% raw %}{% include gallery.html collection='hdadr' facet_by='object_type|location|tags*' num_column=4 %}{% endraw %}`
...
`{% raw %}{% include gallery.html collection='hdadr' field='object_type' value='portrait' num_column=4 %}{% endraw %}`
...
`{% raw %}{% include gallery.html collection='hdadr' field='object_type' value='manuscript' facet_by='location|current_location' num_column=4 %}{% endraw %}`
...
\\
`{% raw %}{% include gallery.html collection='hdadr' facet_by='object_type' num_column=4 %}{% endraw %}`
